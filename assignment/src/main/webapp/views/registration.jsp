...
<jsp:useBean id="errorBean" class="at.ac.tuwien.big.we16.ue3.model.ErrorBean" scope="request"/>
    ...
    <form class="form" method="post">
        ...
        <fieldset>
            ...
            <div class="form-row">
                ...
                <label class="form-label" for="firstname-input" style="color:red;"><%=errorBean.getFirstnameError()%></label>
            </div>
            <div class="form-row">
                ...
                <label class="form-label" for="lastname-input" style="color:red;"><%=errorBean.getLastnameError()%></label>
            </div>
            <div class="form-row">
                ...
                <label class="form-label" for="dateofbirth-input" style="color:red;"><%=errorBean.getDateError()%></label>
            </div>
            <div class="form-row">
                ...
                <label class="form-label" for="email-input" style="color:red;"><%=errorBean.getEmailError()%></label>
            </div>
            <div class="form-row">
                ...
                <label class="form-label" for="password-input" style="color:red;"><%=errorBean.getPasswordError()%></label>
            </div>
        </fieldset>
